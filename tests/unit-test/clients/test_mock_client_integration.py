...
class TestMockClientIntegration:
    ...
    def test_conversation_service_with_mock_client_streaming(self, conversation_service, mock_st):
    ...
    def test_prepare_streaming_chunks_integration(self, conversation_service, mock_st):
        ...
        mock_st.session_state.streaming_response = ""  # Initialize this to prevent += error
